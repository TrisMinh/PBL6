...
- Active baseline: [SRS 2.0.0](./v2/README.md).
- Historical baseline: [SRS 1.0.0](./v1/README.md).
- Current Word release: [`PBL6-SRS-v001.docx`](./word/releases/PBL6-SRS-v001.docx).

## Lịch sử phiên bản nội dung

| Phiên bản | Ngày baseline | Trạng thái | Vị trí | Ghi chú |
|---|---|---|---|---|
| 1.0.0 | 2026-08-19 | Superseded | [`srs/v1`](./v1/README.md) | Baseline mô-đun ban đầu; được giữ nguyên để truy vết lịch sử. |
| 2.0.0 | 2026-09-09 | Accepted, active | [`srs/v2`](./v2/README.md) | Baseline triển khai MVP; hợp nhất phạm vi, nghiệp vụ, yêu cầu, trạng thái và tiêu chí nghiệm thu. |
...
| v001 | 2026-09-11 | Current Word release | [`PBL6-SRS-v001.docx`](./word/releases/PBL6-SRS-v001.docx) | Chuẩn hóa caption/bảng và chèn 48 diagram từ bộ tài liệu SRS 2. |

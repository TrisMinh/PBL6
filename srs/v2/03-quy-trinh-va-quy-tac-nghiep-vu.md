...
**Tham chiếu:** `UC-OPS-05`. Quy tắc liên quan: `BR-TRIP-001..002`, `BR-SEAT-010` và `BR-TENANT-*`. Sơ đồ: [Sequence publish Trip](../../docs/system-design/02-03-sequence-diagrams/04-operator-trip-checkin.md).

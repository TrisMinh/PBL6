...
| IBL-004 | 2026-09-12 | Tách SRS khỏi tài liệu kỹ thuật và loại bỏ artifact sinh tự động. | Accepted, active | `srs/` giữ baseline và Word; `docs/` giữ tài liệu kỹ thuật; không lưu diagram HTML hoặc ảnh QA render trong repository. |

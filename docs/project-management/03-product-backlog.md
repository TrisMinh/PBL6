...
Backlog này phân rã [MVP delivery plan](../implementation/02-mvp-delivery-plan.md) thành card có thể giao cho một người. Chi tiết checklist cho sprint đang chạy nằm trong `board/sprint-*.md`; board chỉ chứa trạng thái hiện tại, không nhân bản toàn bộ mô tả.
...
Trace: [repository structure](../implementation/01-repository-structure.md), [configuration baseline](../implementation/03-configuration-baseline.md), [prerequisites](../implementation/05-development-prerequisites.md).

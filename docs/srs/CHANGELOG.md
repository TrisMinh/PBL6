...
| 2.0.0 | 2026-09-09 | Accepted, active | [`docs/srs/v2`](./v2/README.md) | Baseline triển khai MVP; hợp nhất phạm vi, nghiệp vụ, yêu cầu, trạng thái và tiêu chí nghiệm thu. |

...
- [Use Case Operator Staff và Driver](../../../system-design/02-02-use-case-diagrams/04-operator-trip-checkin.md)
- [Use Case Admin](../../../system-design/02-02-use-case-diagrams/06-administration-reporting.md)
...
| Mục đích | Sơ đồ |
|---|---|
| Giữ ghế | [Sequence SeatHold](../../../system-design/02-03-sequence-diagrams/02-search-booking-ticket.md) |
| Tạo Booking | [Sequence Create Booking](../../../system-design/02-03-sequence-diagrams/02-search-booking-ticket.md) |
| Thanh toán với provider | [Sequence Payment Provider](../../../system-design/02-03-sequence-diagrams/03-payment-cancellation-change.md) |
| Xác nhận Payment và Booking | [Sequence Payment Confirm Booking](../../../system-design/02-03-sequence-diagrams/03-payment-cancellation-change.md) |
| Phát hành Ticket | [Sequence Ticket Delivery](../../../system-design/02-03-sequence-diagrams/03-payment-cancellation-change.md) |
| Preview hủy | [Sequence Cancellation Preview](../../../system-design/02-03-sequence-diagrams/03-payment-cancellation-change.md) |
| Refund | [Sequence Refund Saga](../../../system-design/02-03-sequence-diagrams/03-payment-cancellation-change.md) |
| Publish Trip | [Sequence Publish Trip](../../../system-design/02-03-sequence-diagrams/04-operator-trip-checkin.md) |
| Hủy Trip | [Sequence Cancel Trip](../../../system-design/02-03-sequence-diagrams/04-operator-trip-checkin.md) |

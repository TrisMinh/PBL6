...
- [ ] `dotnet restore` và `dotnet build` pass với working directory là `workspace/`.
...
- [ ] Tạo npm workspace và một lockfile duy nhất trong `workspace/`.
- [ ] Cấu hình TypeScript strict, Vite, lint, format và unit test.
- [ ] Không trộn npm/pnpm/yarn.
- [ ] Các command tại `workspace/` chạy build/test/lint từng app và toàn workspace.
